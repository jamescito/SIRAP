<x-app-layout>
    ...
    <div class="py-10">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-1">
            ...
            <form action="/editoriales/{{$editorial->id}}"class="p-5 w-full max-w-lg bg-gray-300  mx-auto  overflow-hidden shadow-xl sm:rounded-lg py-3 -mt-16" method="post">
            @method('PUT')
            @csrf()
